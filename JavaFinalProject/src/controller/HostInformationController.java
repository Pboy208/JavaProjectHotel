...
public class HostInformationController implements Initializable {	
	...
	public static void setHotel(Hotels hotel) {
		HostInformationController.hotel = hotel;
	}
	...
	public void viewDetail(ActionEvent event) {
		...
		new SceneChanging().changeScene(event, "HotelInformation.fxml");
	}
