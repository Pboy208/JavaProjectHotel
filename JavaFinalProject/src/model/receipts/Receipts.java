...
import controller.HostInformationController;
...
public class Receipts {
	...
	public static void cancelReceiptHotel(int receiptID) throws SQLException {
		String queryStatement = String.format("CALL CancelReceiptHotel(%d,%d)",receiptID,HostInformationController.getHotel().getHotelID());
		System.out.println(String.format("CALL CancelReceiptHotel(%d,%d)",receiptID,HostInformationController.getHotel().getHotelID()));
		Mysql.executeQuery(queryStatement);
	}
	...
	public static ArrayList<Receipts> queryReceiptsForHotel() throws SQLException {
		...
		String queryStatement= String.format("SELECT receipt.*,hotel.id FROM receipt JOIN room ON (receipt.room_id = room.id) "
					...
					+ "WHERE hotel_id = %s", HostInformationController.getHotel().getHotelID());
