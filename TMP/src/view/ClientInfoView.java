...
public class ClientInfoView implements Initializable {
	...
	public void saveChange(ActionEvent event) throws SQLException {
		...
		Clients user = (Clients) LoginView.getUser();
	...
	public void cancelReceipt(ActionEvent event) throws SQLException {
		...
		ReceiptDB.updateReceiptStatusClients(LoginView.getUser().getId());
		ArrayList<Receipts> receipts = ReceiptDB.queryReceiptsForClient(LoginView.getUser().getId());
		if (receipts == null) {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		try {
			...
			System.out.println("This user done have any receipt");
		}
